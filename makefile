...
FILES_TO_COMPILE = src\EntryPoint.cpp src\CPUZ80.cpp src\CPUInstructionHandlers.cpp src\Memory.cpp src\Cartridge.cpp src\MasterSystem.cpp src\VDP.cpp src\Utils.cpp src\PSG.cpp

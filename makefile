...
FILES_TO_COMPILE = src\entryPoint.cpp src\cpuZ80.cpp src\cpuTester.cpp src\cpuInstructionHandlers.cpp src\memory.cpp src\cartridge.cpp src\masterSystem.cpp src\vdp.cpp
